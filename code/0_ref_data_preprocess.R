...
rds_fn <- "/cluster/home/yjliu_jh/projects/mef2d/data/public/rds"

# ====== adult bone marrow ======

bm_1 <- readr::read_csv("/cluster/home/yjliu_jh/projects/mef2d/data/public/CensusImmune-BoneMarrow-10x_cell_type_2020-03-12.csv")
l_bm_1 <- connect(filename = "/cluster/home/yjliu_jh/projects/mef2d/data/public/1M-immune-human-immune-10XV2.loom",
...
bld_1 <- readr::read_csv("/cluster/home/yjliu_jh/projects/mef2d/data/public/CensusImmune-CordBlood-10x_cell_type_2020-03-12.csv")
l_bld_1 <- connect(filename = "/cluster/home/yjliu_jh/projects/mef2d/data/public/1M-immune-human-blood-10XV2.loom",
                   mode = "r+", skip.validate = T)
...
h5ad1 <- read_h5ad("/cluster/home/yjliu_jh/projects/mef2d/data/public/fig1b_fbm_scaled_gex_updated_dr_20210104.h5ad")
...
data_fn <- "/cluster/home/yjliu_jh/projects/mef2d/data"
ref_loc <- "/cluster/home/yjliu_jh/projects/mef2d/data/public/GSE116256_RAW"
