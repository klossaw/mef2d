...
# read in data
mef2d <- readr::read_rds("/cluster/home/yjliu_jh/projects/mef2d/data/merged_4_tumors_new.rds")
...
ggsave(psub1, filename = "/cluster/home/yjliu_jh/projects/temp/mef2d_umap_allsamples.pdf", width = 5, height = 4)

psubsep1 <- DimPlot(mef2d_sub, split.by = "cell_types_broad", reduction = 'umap', label = F) + NoLegend() + 
  scale_color_manual(values = cell_color)

ggsave(psubsep1, filename = "/cluster/home/yjliu_jh/projects/temp/mef2d_umap_all_sep.pdf", width = 12, height = 3)
...
readr::write_rds(cds2, "/cluster/home/yjliu_jh/projects/mef2d/analysis/cds_ordered_m2x.rds")

cds_test2 <- monocle::reduceDimension(cds2, max_components = 2, method = 'DDRTree')
readr::write_rds(cds_test2, "/cluster/home/yjliu_jh/projects/mef2d/analysis/cds_ordered_m2x.rds")
...
readr::write_rds(cds_test2, "/cluster/home/yjliu_jh/projects/mef2d/analysis/cds_ordered_m2xx.rds")
...
pdf("/cluster/home/yjliu_jh/projects/temp/trajectory_ddrtree_monocle2_0321.pdf", width = 10, height = 5)
pm_all
dev.off()
...
readr::write_rds(cds_test3, "/cluster/home/yjliu_jh/projects/mef2d/output/ddrtree_object_tumor.rds")
...
pdf("/cluster/home/yjliu_jh/projects/temp/trajectory_ddrtree_monocle2_0321_ordered.pdf", width = 10, height = 5)
pm_all
dev.off()
