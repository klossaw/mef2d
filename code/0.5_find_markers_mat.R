...
ref_mat <- readr::read_rds("/cluster/home/yjliu_jh/projects/mef2d/data/ref_cells_lsc_mat.rds")
ref_anno <- readr::read_rds("/cluster/home/yjliu_jh/projects/mef2d/data/ref_cells_lsc_anno.rds")
...
readr::write_rds(all_markers_leu, "/cluster/home/yjliu_jh/projects/mef2d/data/public/rds/all_markers_leu_1.rds")
