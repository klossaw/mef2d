...
pht6 <- readr::read_rds("/cluster/home/yjliu_jh/projects/mef2d/code/plotht.rds")
...
gene003y <- readr::read_rds("/cluster/home/yjliu_jh/projects/mef2d/code/gene03.rds")
...
pdf("/cluster/home/yjliu_jh/projects/mef2d/output/heatmap_tumor_666.pdf", width = 15, height = 28)
pht6x
dev.off()
...
readr::write_rds(sce_tumor2, "/cluster/home/yjliu_jh/projects/mef2d/data/sce_tumor_final.rds")
