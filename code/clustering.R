...
ancol4 <- readr::read_rds("/cluster/home/yjliu_jh/projects/mef2d/data/test/ancol4.rds")
...
pdf("/cluster/home/yjliu_jh/projects/mef2d/output/test_heatmap7ww_tumor.pdf", width = 18, height = 22)
pht7
dev.off()

pht7i <- quick_pht(pht6data, "complete")

pdf("/cluster/home/yjliu_jh/projects/mef2d/output/test_heatmap7cp_tumor.pdf", width = 18, height = 22)
pht7i
dev.off()
...
readr::write_rds(annocol4, "/cluster/home/yjliu_jh/projects/mef2d/output/annocol.rds")
annocol4 <- readr::read_rds("/cluster/home/yjliu_jh/projects/mef2d/output/annocol.rds")
...
readr::write_rds(sce_tumor_fil, "/cluster/home/yjliu_jh/projects/mef2d/data/sce_tumor_fil.rds")
